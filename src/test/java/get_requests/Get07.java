...
public class Get07 extends JsonPlaceHolderBaseUrl {
    ...
    public void get07(){
        ...
        List<Object> list = jsonPath.getList("findAll{it.id>190}.id");// Groovy java temelli bir programlama dili
        ...
        List<Integer> userIdList = jsonPath.getList("findAll{it.ad<5}.userId");
